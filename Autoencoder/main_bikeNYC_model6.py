...
def train_model(encoder_blocks, lstm_units, lr, batch_size, kernel_size, num_res, Att, save_results=False, i=''):
    ...
    # model.summary()
    hyperparams_name = '{}.BikeNYC{}.c{}.p{}.t{}.encoderblocks_{}.lstm_{}.kernel_size_{}.lr_{}.batchsize_{}.num_res_{}.Att_{}'.format(
        model_name, i, len_closeness, len_period, len_trend, encoder_blocks,
        lstm_units, kernel_size, lr, batch_size, num_res, Att)
