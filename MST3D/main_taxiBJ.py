...
from deepst.model import mst3d_bj
...
def build_model(save_model_pic=False):
    model = mst3d_bj(len_closeness, len_period, len_trend, nb_flow, map_height, map_width, external_dim)
    adam = Adam(lr=lr)
...
for i in range(0,10):
    ...
    # save to csv
    csv_name = os.path.join('results','mst3d_taxiBJ_results.csv')
